    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="flex gap-2 ps-[9px]">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="harbor-skel h-11 w-36 shrink-0 rounded-full bg-elevated" />
        ))}
      </div>
      ...
      {[0, 1].map((r) => (
        <div key={r} className="flex flex-col gap-4">
          <div className="flex flex-col gap-2 ps-[9px]">
            <div className="harbor-skel h-4 w-40 rounded-md bg-elevated" />
            <div className="harbor-skel h-4 w-56 rounded-md bg-elevated" />
          </div>
