...
// Logic mirrors src/components/onboarding/language-step.tsx; presentation is
// single-column touch rows instead of the desktop 2-up grid.
export function ObLanguage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div role="radiogroup" aria-label={t("Display language")} className="flex flex-col gap-2.5">
        {LANGUAGES.map((lang, i) => {
          ...
          return (
            <button
              ...
              className={`flex w-full items-center gap-3.5 rounded-2xl border px-5 py-4 text-start transition-colors ${
                selected
                  ? "border-ink bg-elevated"
                  : "border-edge-soft bg-canvas/40 active:bg-canvas/60"
              }`}
            >
              <span
