...
// Logic mirrors src/components/onboarding/streaming-step.tsx; 3-col logo grid so
// all 12 services sit above the fold on a 390x844 viewport.
export function ObStreaming() {
            ...
            <button
              ...
              className={`relative flex h-[64px] items-center justify-center overflow-hidden rounded-xl border px-2 transition-all ${
                on
                  ...
                  : "border-edge-soft bg-canvas opacity-55"
              }`}
            >
