  ...
  return (
    ...
    >
      <div
        ...
        className="pointer-events-auto flex flex-wrap items-center justify-center gap-4 rounded-md bg-elevated px-4 py-3 shadow-[0_10px_30px_-12px_rgba(0,0,0,0.6)]"
