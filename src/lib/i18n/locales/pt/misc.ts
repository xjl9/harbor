const misc: Record<string, string> = {
  ...
  "Hero carousel, Top 10, curated rails.":
    "Carrossel de destaques, Top 10 e fileiras selecionadas.",
  ...
  "Addons are where catalogs and streams come from, and Harbor starts with none. Add one now so the first title you open has something to play.":
    "Os addons fornecem os catálogos e streams, e o Harbor começa sem nenhum. Adicione um agora para que o primeiro título que você abrir tenha algo para reproduzir.",
  "Could not install that addon.": "Não foi possível instalar esse addon.",
  "Add or remove sources anytime from Profile, under Addons.":
    "Você pode adicionar ou remover fontes quando quiser no Perfil, em Addons.",
  "Not sure which? Torrentio and Cinemeta cover most people. You can change this later in Profile, under Addons.":
    "Não sabe qual escolher? Torrentio e Cinemeta atendem à maioria das pessoas. Você pode mudar isso depois no Perfil, em Addons.",
  ...
  "Connect a debrid provider to see cached streams that can start immediately. This is optional, requires a separate paid provider account, and can be configured later in Settings.":
    "Conecte um provedor de debrid para ver streams em cache que podem começar imediatamente. Isso é opcional, exige uma conta paga separada no provedor e pode ser configurado depois em Configurações.",
  ...
  "No debrid? Skip this. Harbor still finds free public streams, they can just be slower.":
    "Sem debrid? Pule esta etapa. O Harbor ainda encontra streams públicos gratuitos, mas eles podem ser mais lentos.",
